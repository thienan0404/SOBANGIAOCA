export enum HandoverStatus { DRAFT='DRAFT', SUBMITTED='SUBMITTED', PENDING_RECEIVER_CONFIRMATION='PENDING_RECEIVER_CONFIRMATION', PENDING_MANAGEMENT_APPROVAL='PENDING_MANAGEMENT_APPROVAL', PENDING_ACCOUNTING_APPROVAL='PENDING_ACCOUNTING_APPROVAL', MANAGEMENT_CHANGES_REQUESTED='MANAGEMENT_CHANGES_REQUESTED', ACCOUNTING_CHANGES_REQUESTED='ACCOUNTING_CHANGES_REQUESTED', SUPPLEMENT_REQUESTED='SUPPLEMENT_REQUESTED', RESUBMITTED='RESUBMITTED', CONFIRMED='CONFIRMED', COMPLETED='COMPLETED', CANCELLED='CANCELLED', OVERDUE='OVERDUE' }
