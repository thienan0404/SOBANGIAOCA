...
export const metadata:Metadata={title:'A25 Hotel | Sổ bàn giao ca',description:'Hệ thống bàn giao ca lễ tân điện tử dành cho vận hành A25 Hotel.',applicationName:'A25 - Sổ bàn giao ca',icons:{icon:[{url:'/a25-logo.png',type:'image/png'}],shortcut:'/a25-logo.png',apple:'/a25-logo.png'}};
