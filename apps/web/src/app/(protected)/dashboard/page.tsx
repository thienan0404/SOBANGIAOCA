...
export default function Dashboard(){
  ...
  useEffect(()=>{queueMicrotask(()=>{setEmployee(localStorage.getItem('a25.employeeName')||'Nhân viên lễ tân');setBranch(localStorage.getItem('a25.branchName')||'Chi nhánh đang làm việc');const branchId=localStorage.getItem('a25.branchId');if(branchId)void handoverApi.formContext(branchId).catch(()=>undefined)})},[]);
  return <>
